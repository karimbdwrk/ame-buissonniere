...
<div class="container">
	<div class="row">
					...
					<tbody>
						...
						<tr>
							<td colspan="6" class="actions">
								...
								<button type="submit" class="button" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><i class="fas fa-sync-alt"></i></button>
		...
		<div class="col-12 col-sm-4">
			...
			<div class="upsell-shop">
				<h4>VOUS AIMEREZ <em>aussi</em></h4>
				<div class="item">
